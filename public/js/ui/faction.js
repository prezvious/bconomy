...
const renderUnaffiliated = () => {
    ...
    if (unaffiliatedTab === 'discover') {
        content = `
            <div class="faction-toolbar"><input id="faction-directory-search" class="form-input" maxlength="64" placeholder="Search public factions, Leaders, or faction numbers"><button class="action-btn secondary-btn" type="button" data-faction-action="directory-search">Search</button></div>
