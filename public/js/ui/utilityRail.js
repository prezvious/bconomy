...
const inferHelpContextFromTarget = target => {
    ...
    const mappings = [
        ...
        ['#faction-deposit-input, [data-faction-action="deposit"]', 'faction', 'treasury'],
        ['[data-faction-tab="operations"], .faction-boost-card, [data-faction-action="activate-boost"], [data-faction-action="stop-boost"]', 'faction', 'operations'],
        ['[data-faction-tab="members"], .faction-member-row', 'faction', 'members'],
        ['[data-faction-tab="recruitment"], [data-faction-action="save-mode"], [data-faction-action="player-search"]', 'faction', 'recruitment'],
        ['[data-faction-tab="permissions"], .faction-permission-table', 'faction', 'ranks'],
        ['#faction-join-request-modal, [data-faction-action="open-request"]', 'faction', 'requests'],
        ['#faction-code-input, .faction-generated-code, [data-faction-action="generate-code"]', 'faction', 'codes'],
        ['[data-faction-action="transfer"], [data-faction-action="disband"]', 'faction', 'leadership'],
        ['[data-faction-action="open-create"], [data-faction-action="open-edit"], #create-faction-modal, #edit-faction-modal', 'faction', 'overview'],
